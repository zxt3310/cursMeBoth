...
- (void)newsListRequest:(NSInteger)qtypeId{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"http://new.medapp.ranknowcn.com/h5_new/server/app.php?type=newslist&appid=4&qtype=%ld&limit=%ld",qtypeId,numberOfCurrentRows + 15];
