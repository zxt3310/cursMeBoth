...
{
    NSString *finalPost = [[NSString alloc] initWithFormat:@"%@&deviceid=%@&appid=4&source=apple&imei=%@", post, [[NSUserDefaults standardUserDefaults] objectForKey:USER_UNIQUE_ID],[CureMeUtils defaultCureMeUtil].UDID];
...
{
    NSString *finalPost = [NSString stringWithFormat:@"%@&version=3.0&deviceid=%@&appid=4&source=apple", post, [[NSUserDefaults standardUserDefaults] objectForKey:USER_UNIQUE_ID]];
...
/*
 ...
 {
 NSString *finalPost = [NSString stringWithFormat:@"%@&version=2.2&deviceid=%@&appid=4&source=apple", post, [[NSUserDefaults standardUserDefaults] objectForKey:USER_UNIQUE_ID]];
 NSLog(@"sendRequestWithFullURL:%@ post:%@", fullURL, finalPost);
