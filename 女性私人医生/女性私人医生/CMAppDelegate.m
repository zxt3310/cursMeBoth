...
//    [webVC setStrURL:[[NSString alloc] initWithFormat:@"http://new.medapp.ranknowcn.com/h5_new/news.html?appid=4&addrdetail=%@&source=apple",[CureMeUtils defaultCureMeUtil].encodedLocateInfo]];
...
{
    WebViewController *webVC = [[WebViewController alloc] initWithNibName:@"WebViewController" bundle:nil];
    [webVC setStrURL:[NSString stringWithFormat:@"http://app.imeirong.com/applist.php?appid=4"]];
...
- (void)getAllOfficeTypeAndUrl{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"http://new.medapp.ranknowcn.com/api/m.php?action=getallqtypebyappidandgps&appid=4&addrdetail=%@&version=3.0",encodedLocateInfo];
