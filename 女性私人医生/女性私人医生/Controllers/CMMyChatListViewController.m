...
//        }
        ...
        post = [NSString stringWithFormat:@"source=apple&imei=%@&token=%@&version=3.3&appid=4&deviceid=%@&swtuserid=%ld&os=ios&userid=%ld",[CureMeUtils defaultCureMeUtil].UDID,nil,[[NSUserDefaults standardUserDefaults] objectForKey:USER_UNIQUE_ID],[CureMeUtils defaultCureMeUtil].userSWTID,[CureMeUtils defaultCureMeUtil].userID];
