...
- (void)viewDidLoad {
    ...
    UILabel *pwdLb = [[UILabel alloc] initWithFrame:CGRectMake(42*SCREEN_WIDTH/375, 337*SCREEN_HEIGHT/667, 30, 15)];
    pwdLb.text = @"密码";
    ...
    codeTf = [[UITextField alloc] initWithFrame:CGRectMake(107*SCREEN_WIDTH/375, 258*SCREEN_HEIGHT/667, 150, 15)];
    codeTf.placeholder = @"请输入验证码";
    passwrdTf = [[UITextField alloc] initWithFrame:CGRectMake(107*SCREEN_WIDTH/375, 337*SCREEN_HEIGHT/667, 150, 15)];
    ...
    regiestBtn.frame = CGRectMake(43*SCREEN_WIDTH/375, 423*SCREEN_HEIGHT/667, 290*SCREEN_WIDTH/375, 40);
...
- (void)registBtnClick{
    ...
    post = [[NSString alloc] initWithFormat:@"action=register&mobile=&username=%@&password=%@&addrdetail=%@&token=%@&city=&city2=&mobile=", encodedUserName, encodedPassword, encodeAddr ? encodeAddr : @"", nil];
