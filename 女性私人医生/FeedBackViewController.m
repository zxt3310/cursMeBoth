...
- (void)sendBtnClick{
    ...
    NSString *post = [NSString stringWithFormat:@"source=apple&os=ios&appid=4&version=3.3&deviceid=%@&userid=%ld&imei=%@&content=%@&contacts=%@",[CureMeUtils defaultCureMeUtil].uniID,[CureMeUtils defaultCureMeUtil].userID,[CureMeUtils defaultCureMeUtil].UDID,feedView.text,mailTf.text];
